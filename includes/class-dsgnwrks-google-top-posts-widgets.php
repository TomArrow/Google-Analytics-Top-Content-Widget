 ...
 * Description: Widget and shortcode to display top content according to Google Analytics. This version is modified to sort by bounce rate. ("Google Analytics by Yoast" plugin required)
